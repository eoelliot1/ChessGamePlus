...
This project is licensed under a custom license. You are permitted to view the source code for personal, educational, or research purposes only. Any other use, including but not limited to copying, modifying, merging, publishing, distributing, sublicensing, or selling copies of the software, is strictly prohibited. For full details, see the [LICENSE](LICENSE.txt) file.
